...
const messages = [
  ...
  "Wait, think bout it yes is nicer",
  "I really think yes fits you more",
  "Come on now Yes",
  "Dont be a party pooper!!",
  "hmm you really are persistent, Yes better",
  "Nee nee, give in",
  "Catch me if you can"
 ];
...
function createMessageBox(message) {
  ...
  // Position the message box at the same position as the button
  const noBtnRect = noBtn.getBoundingClientRect();
  messageBox.style.left = noBtnRect.left + 'px';
  messageBox.style.top = (noBtnRect.top - messageBox.offsetHeight) + 'px'; // Position the message box above the button
...
yesBtn.addEventListener("click", () => {
  question.innerHTML = "HAHA LETS GOOO!! Text me what days you are free ";
  gif.src =
